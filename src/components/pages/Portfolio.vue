  ...
  <div class="portfolio">
    ...
    <b-row v-for="category in work" :key="category.id" class="border-bottom-green py-3">
      <b-col cols="12" class="pb-4">
        <h2 class="h3 text-green">{{ category.category }}</h2>
      </b-col>
      <portfolio-item
          ...
          projects: [
            {
              ...
              description: 'A colorful Wordpress site built with Sage 9 that uses CSS/SVG animations and cartoonesque parallax layers.',
              link: ''
            },
            {
              title: 'Metro Optical',
